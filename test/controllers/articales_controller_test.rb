...
class ArticalesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create articale" do
    assert_difference('Articale.count') do
      post articales_url, params: { articale: { description: @articale.description, title: @articale.title } }
    end
  ...
  test "should update articale" do
    patch articale_url(@articale), params: { articale: { description: @articale.description, title: @articale.title } }
